...
void RenderToTextureClass::GetProjectionMatrix(XMMATRIX& projectionMatrix)
{
...
float RenderToTextureClass::GetTextureWidth()
{
	return m_textureWidth;
}

float RenderToTextureClass::GetTextureHeight()
{
