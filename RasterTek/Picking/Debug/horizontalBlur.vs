...
// 화면의 width (= render to texture의 width)를 셰이더에서 알아야 한다.
// 그래야 각 픽셀의 uv coordinate를 알 수 있다. 이것을 texel 이라고 한다.
...
// 현재 pixel과 각 방향으로 4개씩의 픽셀 uv 위치 정보를 담는다.
...
PixelInputType HorizontalBlurVertexShader(VertexInputType input)
{
    ...
    // determine the floating point size of a texel for a zcreen with this specific width
