...
bool TextureShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, LPCWSTR vsFilename, LPCWSTR psFilename)
{
	...
	// input per instance data. TEXCOORD[1] slot..
	// Position 정보를 담을 것이기 때문에 format은 DXGI_FORMAT_R32G32B32_FLOAT 이다.
	// Instance buffer의 첫 번째 unit이기 때문에 AlignedByteOffset은 0 이다.
